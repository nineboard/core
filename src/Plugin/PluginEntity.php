 ...
 * @method void install()
 * @method bool checkInstalled($currentVersion = null)
 * @method void update()
 * @method bool checkUpdated($currentVersion = null)
...
class PluginEntity implements Arrayable, Jsonable
{
     ...
     *
     * @return bool 설치가 필요할 경우 true를 반환
     */
     ...
     *
     * @return bool 새버전이 서버에 존재할 경우 true를 반환
     */
    ...
    {
        return call_user_func_array([$this->getObject(), $method], $arguments);
    }
     ...
     *
     * @return bool 해당 경로에 autoload 파일이 존재하는지 유무
     */
