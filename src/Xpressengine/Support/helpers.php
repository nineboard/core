...
if (function_exists('xe_trans') === false) {
     ...
     * @return string
     */
    function xe_trans($id = null, $parameters = [], $locale = null)
    {
        if (is_null($id)) {
...
if (function_exists('xe_trans_choice') === false) {
     ...
     * @return string
     */
    function xe_trans_choice($id, $number, array $parameters = [], $locale = null)
    {
...
if (! function_exists('instance_route')) {
     ...
     * @return string
     */
    function instance_route($name, $parameters = [], $instanceId = null, $absolute = true, $route = null)
    {
        if ($instanceId === null) {
